...
import mods_utiles_1604 as mods
import main_kringing_1604 as krg
...
def test_3D():
    ...
    loc_X,loc_y = mods.generar_input(file,lineas,dim=3,ruta=main_ruta)
...
def cargar():
    loaded_model = mods.exp_imp_meta(0,0,'16_04_wind_models/full_BR_AR')
    return(loaded_model)
